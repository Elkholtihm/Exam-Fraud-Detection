...
This project uses computer vision to detect cheating in online exams. Utilizing the YOLOv8 model, the system identifies suspicious actions and sends real-time notifications through a Telegram bot.
